"""
API_RateLimiter.py —— 轉發層（階段 1）

實作已搬到 tmsapi.ratelimit，本檔只把自己**替換**成那個模組。
...
回退方式：把本檔換回 git 中的原始內容（備份在 functions/_pre_tmsapi_backup/API_RateLimiter.py）。
"""

import sys as _sys

from tmsapi.ratelimit import *          # noqa: F401,F403  —— 讓靜態檢查看得到名稱
import tmsapi.ratelimit as _impl
